...
import { consultaSimplesPrice } from "@/utils/prices";
import PaymentComplete from "@/blocks/paymentComplete";
import ConsultaSimplesDialog from "@/components/dialog/ConsultaSimplesDialog/ConsultaSimplesDialog";
...
export default function ConsultaSimples() {
    ...
    const [amount] = useState(consultaSimplesPrice);
    ...
    return (
        <LayoutDashboard>
            <div className="max-w-2xl mx-auto space-y-8 py-8 px-6 bg-white shadow-lg rounded-lg">
                <TitleDashboard title="Consultas Simples" />
                <SectionDashboard consultationType="Consulta Simples" price={consultaSimplesPrice} />
                <div className="flex items-center justify-center">
                    <OpenDialogButton handleClickOpen={handleClickOpen} queryType={"Consulta Simples"} />
                </div>
                {open && (
                    <ConsultaSimplesDialog handleClose={handleClose} open={open} setOpen={setOpen} />
                )}
